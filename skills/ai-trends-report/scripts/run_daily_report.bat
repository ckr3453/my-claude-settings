...
echo [%date% %time%] AI Trends Report Start >> "%LOGFILE%"

node "%USERPROFILE%\AppData\Roaming\npm\node_modules\@anthropic-ai\claude-code\cli.js" -p "/ai-trends-report" --model claude-sonnet-4-6 --allowedTools "WebFetch,WebSearch,Read,Write,Bash,Glob,Grep" >> "%OUTLOG%" 2>&1
