...
def main():
    parser = argparse.ArgumentParser(description='Send AI Trends Report via email')
...
{html_body}
    ...
    for old_file in temp_dir.glob('ai_trends_report_*.md'):
        old_file.unlink()
